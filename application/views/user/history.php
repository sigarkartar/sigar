        ...
        <table class="table table-bordered" style="text-align: center;">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="<?= base_url('user/ubah_data') ?>?id=<?= $x['id_data'] ?>" type="submit" class="btn btn-warning">Ubah</a><br><br>
                        <a href="<?= base_url('user/hapus_data') ?>?id=<?= $x['id_data'] ?>" type="submit" class="btn btn-danger tombol-hapus">Hapus</a>
                    </td>
                </tr>
            <?php
                $no++;
