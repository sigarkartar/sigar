    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <p class="intro-subtitle"><span class="text-slider-items">Karang taruna RT 03 RW 02</span><strong class="text-slider"></strong></p>
          ...
          <div id="testimonial-mf" class="owl-carousel owl-theme">
            <div class="testimonial-box">
              <div class="author-test">
                ...
                <span class="author">Boy diego</span>
              </div>
              <div class="content-test">
                <p class="description lead">
                  Ketua karang taruna wonokromo cabang purnama
                </p>
        ...
        <div class="col-md-4">
          <div class="card card-blog">
            ...
            <div class="card-body">
              ...
              <h3 class="card-title"><a href="blog-single.html">berjemur Di kebon</a></h3>
